function startApp() {
    ...
    const kinveyAppKey = "kid_SkRHyi6ir";
    const kinveyAppSecret = "3c7a726bb6564df78e3f4432e88d0898";
    ...
    function listAds() {
        ...
        function loadAdsSuccess(ads) {
            ...
            function appendAdRow(ad, adsTable) {
                ...
                adsTable.append($('<tr>')
                    .append($('<img>').attr('src', ad.image).attr('width', '150px'), $('<td>').text(ad.title), $('<td>').text(ad.description), $('<td>').text(ad.publisher), $('<td>').text(ad.datePublished), $('<td>').text(ad.price),$('<td>').append(links)
                    ));
            }
        }
    }
